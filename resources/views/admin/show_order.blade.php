...
{{--
                                ...
                                <p>{{__('admin.Sub Total')}} : {{ $currency_icon->icon }}{{ $order->package_amount }}</p>
                                <p>{{__('admin.Additional')}} : {{ $currency_icon->icon }}{{ $order->additional_amount }}</p>
                                <p>{{__('admin.Total Amount')}} : {{ $currency_icon->icon }}{{ $order->total_amount }}</p>
                                ...
                                @if (count($additional_services) > 0)
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $currency_icon->icon }}{{ $additional_service->price }}</td>
                                        </tr>
                                        @endforeach
                                    </table>
                                @endif
