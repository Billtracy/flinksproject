...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(isset($setting->selected_theme)){
        ...
        if(isset($intro->status) && $intro->status == 1) $intro_visibility = true;
    ...
    public function service($slug){
        ...
        $currency_icon = (object) array('icon' => $setting->currency_icon);
        $show_provider_contact_info = (object) array('status' => $setting->show_provider_contact_info);
