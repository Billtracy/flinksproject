...
class HomeController extends Controller
{
    public function website_setup(){
        ...
        $setting = Setting::select('id','logo','favicon','text_direction','timezone','topbar_phone','topbar_email','opening_time','currency_name','currency_icon','login_image','selected_theme','theme_one_color','theme_two_color','theme_three_color')->first();
